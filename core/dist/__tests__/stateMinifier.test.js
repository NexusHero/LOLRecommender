...
describe("minifyGameState", () => {
    it("minifyGameState_StandardMidGameState_ContainsAllPlayerFields", () => {
        const state = (0, fixtures_js_1.makeGameState)({
            gameTime: 125,
            localPlayer: (0, fixtures_js_1.makePlayer)({
                championName: "Ahri",
                level: 6,
                scores: { kills: 2, deaths: 1, assists: 0, creepScore: 30, wardScore: 0 },
                items: [(0, fixtures_js_1.makeItem)({ displayName: "Lost Chapter" })],
            }),
            activePlayer: (0, fixtures_js_1.makeActivePlayer)({ currentGold: 1300 }),
            allies: [
    ...
    it("minifyGameState_EmptyItemsAndTeams_ShowsNonePlaceholders", () => {
        const state = (0, fixtures_js_1.makeGameState)({
            gameTime: 0,
            localPlayer: (0, fixtures_js_1.makePlayer)({ items: [] }),
            activePlayer: (0, fixtures_js_1.makeActivePlayer)({ currentGold: 500 }),
            allies: [],
            enemies: [],
        });
        const result = (0, stateMinifier_js_1.minifyGameState)(state);
        ...
        it("minifyGameState_Level11WithTwoItemsAt15Minutes_FormatsCorrectly", () => {
            const state = (0, fixtures_js_1.makeGameState)({
                ...
                localPlayer: (0, fixtures_js_1.makePlayer)({
                    ...
                    items: [
                        (0, fixtures_js_1.makeItem)({ displayName: "Berserker's Greaves" }),
                        (0, fixtures_js_1.makeItem)({ displayName: "Kraken Slayer" }),
                    ],
                }),
                activePlayer: (0, fixtures_js_1.makeActivePlayer)({ currentGold: 850 }),
            });
            const result = (0, stateMinifier_js_1.minifyGameState)(state);
        ...
        it("minifyGameState_Level18FullBuildAt40Minutes_FormatsCorrectly", () => {
            const state = (0, fixtures_js_1.makeGameState)({
                ...
                localPlayer: (0, fixtures_js_1.makePlayer)({
                    ...
                    items: Array(6).fill((0, fixtures_js_1.makeItem)({ displayName: "Infinity Edge" })),
                }),
                activePlayer: (0, fixtures_js_1.makeActivePlayer)({ currentGold: 3200 }),
            });
            const result = (0, stateMinifier_js_1.minifyGameState)(state);
        ...
        it("minifyGameState_HighKdaAndMassiveGoldLead_FormatsSnowballScenario", () => {
            const state = (0, fixtures_js_1.makeGameState)({
                ...
                localPlayer: (0, fixtures_js_1.makePlayer)({
                    ...
                    items: [(0, fixtures_js_1.makeItem)({ displayName: "Bloodthirster" })],
                }),
